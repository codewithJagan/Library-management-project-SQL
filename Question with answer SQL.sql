...
--TASK 9 List Members Who Registered in the Last 456 Days:

SELECT * FROM members
WHERE reg_date >= CURRENT_DATE - INTERVAL '456 days';
...
--TASK 11 Retrive  Books with Rental Price Above a Certain Threshold: USD 7
